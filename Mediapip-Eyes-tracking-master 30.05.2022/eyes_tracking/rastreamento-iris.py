...
# indices da iris
# Here is the bug, You have switched  the left IRIS landmarks to Right vis versa.
# Here I am keeping you landmarks as it is, adding mine next to it.
# LEFT_IRIS = [474, 475, 476, 477]
# RIGHT_IRIS = [469, 470, 471, 472]

# just comment mine and uncomment yours, and you will find the issue here.
...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        )  # Mediapipe precisa do formato de cores RGB mas o OpenCV usa o BGR
        ...
        if results.multi_face_landmarks:
            ...
            # Draw the center of iris to identify the eyes working on
            cv.circle(frame, center_right, 3, (0, 255, 0), -1, cv.LINE_AA)
            cv.circle(frame, center_left, 3, (255, 0, 255), -1, cv.LINE_AA)
            ...
            # Draw the Eyes Position and Ratio on Screen
            cv.putText(
                frame,
